...
import op.air.airclient.ui.client.altmanager.menus.altgenerator.GuiTheAltening.Companion.apiKey
...
class ValuesConfig(file: File) : FileConfig(file) {
    ...
    override fun loadConfig() {
        ...
        if (prevVersion != AirClient.clientVersionText) {
            // Run backup
            FileManager.backupAllConfigs(prevVersion, AirClient.clientVersionText)
        }
    ...
    override fun saveConfig() {
        ...
        jsonObject.run {
            ...
            addProperty("ClientVersion", AirClient.clientVersionText)
        }
