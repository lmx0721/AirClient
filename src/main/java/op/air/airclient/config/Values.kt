...
import op.air.airclient.utils.kotlin.coerceIn
...
fun intValue(
    ...
    suffix: String? = null
) = IntValue(name, value, range, suffix)
...
fun floatValue(
    ...
    suffix: String? = null
) = FloatValue(name, value, range, suffix)
...
fun choices(
    ...
    values: Array<String>,
    value: String
) = ListValue(name, values, value)

fun font(
    name: String,
    value: FontRenderer
) = FontValue(name, value)
...
fun block(
    name: String,
    value: Int,
    range: IntRange = 1..197
) = BlockValue(name, value, range)
...
fun intRange(
    ...
    range: IntRange = 0..Int.MAX_VALUE,
    suffix: String? = null
) = IntRangeValue(name, value, range, suffix)
