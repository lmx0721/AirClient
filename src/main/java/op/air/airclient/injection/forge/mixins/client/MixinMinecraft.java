...
import op.air.airclient.features.module.modules.combat.AutoClicker;
import op.air.airclient.features.module.modules.combat.TickBase;
import op.air.airclient.features.module.modules.exploit.AbortBreaking;
import op.air.airclient.features.module.modules.exploit.MultiActions;
import op.air.airclient.features.module.modules.world.FastPlace;
import op.air.airclient.file.configs.models.ClientConfiguration;
import op.air.airclient.injection.forge.SplashProgressLock;
import op.air.airclient.ui.client.GuiMainMenu;
...
public abstract class MixinMinecraft {
    ...
    private void init(CallbackInfo callbackInfo) {
        ...
        liquidBounce$preloadFuture = AirClient.INSTANCE.preload();
    }
    ...
    private void startGame(CallbackInfo callbackInfo) throws ExecutionException, InterruptedException {
        ...
        AirClient.INSTANCE.startClient();
    }
    ...
    private void createDisplay(CallbackInfo callbackInfo) {
        if (ClientConfiguration.INSTANCE.getClientTitle()) {
            Display.setTitle(AirClient.INSTANCE.getClientTitle());
        }
    }
