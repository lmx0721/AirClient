 ...
 */
package op.air.airclient.utils.io
...
/**
 * User agent
 * AirClient/<version> (<commit>, <branch>, <build-type>, <platform>)
 */
val DEFAULT_AGENT =
    "${AirClient.CLIENT_NAME}/${AirClient.clientVersionText} (${AirClient.clientCommit}, ${AirClient.clientBranch}, ${if (AirClient.IN_DEV) "dev" else "release"}, ${System.getProperty("os.name")})"
