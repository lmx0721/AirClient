...
object AutoL : Module("AutoL", Category.FUN) {
    ...
    private  val SanGuo = listOf(
        "一破：卧龙出山，你已被SouthSide客户端击杀",
        "双连：一战成名，你已被SilenceFix客户端击杀",
        "三连：举世皆惊，你已被Myau客户端击杀",
        "四连：天下无敌，你已被Opai客户端击杀",
        "五连：诛天灭地，你已被Augustus客户端击杀"
    )
    private val mama = listOf("妈妈")
    private val clear = listOf("L")

    private val prideplus = listOf(
        "嗨，我是风动，这是我的neibu神器，5000收neibu是我的秘密武器，花钱一分钟，赚钱两个月，不要告诉别人哦",
        "嗨，我是Pro，这是我的neibu神器，500块50个conf是我的秘密武器，花钱一分钟，赚钱两年半，不要告诉别人哦",
        "嗨，我是回想，这是我的fix神器，fix各种端是我的秘密武器，fix一小时，高兴一个月，不要告诉别人哦",
        "嗨，我是小职，这是我的cookies神器，5000+cookies是我的秘密武器，获取一秒钟，游戏一小时，不要告诉小手哦",
    ...
    private val cixiaogui = listOf(
        ...
        "你挣扎的样子真像落在窗台上的小雨点~滴滴答答...最后还是要消失呢♡",
    ...
    private val crystalPvP = listOf(
        ...
        "自己找差距", "不接单", "呢", "这样的治好了也流口水", "人机", "人机怎么调难度啊", "只收不被0封的",
        "Bot吗这把", "领养", "纳亲", "正视差距", "近亲繁殖?", "我玩的是新手教程?", "来调灵敏度的", "来调参数呢",
        "小号", "不是本人别加", "下次记得晚点打", "随便玩玩,不带人", "呢上车"
    )
