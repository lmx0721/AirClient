...
object Animations : Module("Animations", Category.RENDER, gameDetecting = false) {
    ...
    val rotation by boolean("Rotation", false) { animationMode == "XinXin" }
    val rotationSpeed by int("RotationSpeed", 2, 1..10) { animationMode == "XinXin" && rotation }
...
class SwangAnimation : Animation("Swang") {
    override fun transform(f1: Float, f: Float, clientPlayer: AbstractClientPlayer) {
        ...
        transformFirstPersonItem(f, 0.0f)
        doBlockTransformations()
        translate(-0.1f, 0.2f, 0.0f)
        rotate(-var9 * 20.0f, 8.0f, 0.0f, 8.0f)
        rotate(var9 * 10.0f, 8.0f, 0.0f, 8.0f)
    }
}
...
class SwingAnimation : Animation("Swing") {
    override fun transform(f1: Float, f: Float, clientPlayer: AbstractClientPlayer) {
        ...
        rotate(-var9 * 40.0f, 8.0f, 0.0f, 8.0f)
        rotate(var9 * 20.0f, 8.0f, 0.0f, 8.0f)
    }
}
...
class SwongAnimation : Animation("Swong") {
    override fun transform(f1: Float, f: Float, clientPlayer: AbstractClientPlayer) {
        ...
        rotate(-var9 * 60.0f, 8.0f, 0.0f, 8.0f)
        rotate(var9 * 30.0f, 8.0f, 0.0f, 8.0f)
    }
}
...
class XinXinAnimation : Animation("XinXin") {
    ...
    override fun transform(f1: Float, f: Float, clientPlayer: AbstractClientPlayer) {
        val enableRotation = Animations.rotation
        val rotSpeed = Animations.rotationSpeed.toFloat()
        val scale = Animations.xinxinScale
