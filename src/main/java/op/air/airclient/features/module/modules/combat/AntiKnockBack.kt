...
object AntiKnockBack : Module("AntiKnockBack", Category.COMBAT) {
    ...
    // 获取KillAura模块
    private val killAuraModule: op.air.airclient.features.module.Module?
        get() = op.air.airclient.features.module.ModuleManager.getModule("KillAura")
