 ...
 */
package op.air.airclient.event

import op.air.airclient.features.module.modules.render.FreeCam
import op.air.airclient.utils.extensions.withY
...
/**
 * Called when AirClient finishes starting up
 */
object StartupEvent : Event()

class ModuleToggleEvent(val module: op.air.airclient.features.module.Module, val state: Boolean) : Event()
